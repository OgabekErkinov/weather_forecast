  ...
  return (
      <div className="w-[90%] h-[90%] bg-white rounded-2xl shadow-xl p-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          {/* Left: Current */}
          <div className="w-full md:w-1/2 bg-blue-100 rounded-xl p-6 flex flex-col items-center justify-center text-blue-900">
          ...
          <div className="w-full md:w-1/2 bg-white rounded-xl p-4 overflow-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {forecast.map((day) => (
                <div
                  key={day.date}
                  className="flex items-center gap-4 bg-blue-50 p-3 rounded-lg shadow-sm hover:shadow-md transition"
                >
